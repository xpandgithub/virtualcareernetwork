...
(function($) {
	Drupal.behaviors.vcnpla_professional_training_details = {
		attach: function(context, settings) {
			...
			var save_courses_ajax_link = basepath+'pla/save-courses/'+ace_id+'/'+start_date+'/'+end_date+'/professional_training';
			
			jQuery('#vcnpla-details-page-save-button button#save-to-wishlist').click(function(){
				vcnSaveTarget(save_courses_ajax_link,'professional_training_course','save', user_id, isUserLoggedIn, 0); 
				return false;
			});
		}
	};
