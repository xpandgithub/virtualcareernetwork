...
(function($) {
	Drupal.behaviors.vcnpla_military_credit_details = {
		attach: function(context, settings) {
			...
			var save_courses_ajax_link = basepath+'pla/save-courses/'+ace_id+'/'+start_date+'/'+end_date+'/military';
			
			jQuery('#vcnpla-details-page-save-button button#save-to-wishlist').click(function(){
				vcnSaveTarget(save_courses_ajax_link,'military_course','save', user_id, isUserLoggedIn, 0); 
				return false;
			});
		}
	};
