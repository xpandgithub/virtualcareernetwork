	...
	<div class="vcn-pla-buttons">
		<div id="vcnpla-details-page-search-again">
			...
			<?php else: ?>
				...
				<?php else: ?>
					<button class="vcn-button detail-back-buttons" id="button-back-to" onclick="location='<?php print $national_exams_link; ?>'" title="Back to National Exams">Back to<br/> National Exams</button>
				<?php endif; ?>
			<?php endif; ?>
		</div>
...
<div id="vcnpla-national-exams-details-ace-id">
	<strong>ACE ID:</strong> <?php print $ace_id; ?>
</div>

<?php if(!empty($first_title)): ?>
	<div id="vcnpla-national-exams-details-first-title">
		<strong>Primary Title:</strong> <?php print $first_title; ?>
	</div>
<?php endif; ?>

<?php if(!empty($second_title)): ?>
	<div id="vcnpla-national-exams-details-secondary-title">
		<strong>Secondary Title:</strong> <?php print $second_title; ?>
	</div>
<?php endif; ?>

<?php if(!empty($objective)): ?>
<div id="vcnpla-national-exams-details-objective">
	<strong>Objective:</strong> <?php print $objective; ?>
</div>
<?php endif; ?>

<?php if(!empty($instruction)): ?>
<div id="vcnpla-national-exams-details-instruction">
	<strong>Instruction:</strong> <?php print $instruction; ?>
</div>
<?php endif; ?>

<?php if(!empty($course_credit_info_array)): ?>
<div id="vcnpla-national-exams-details-course-hours">
	<strong>Course Hours:</strong>
	<ul>
		<?php foreach ($course_credit_info_array as $course_credit_info): ?>
			<li><?php print $course_credit_info->credit_info; ?></li>
		<?php endforeach; ?>
	</ul>
</div>
<?php endif ?>