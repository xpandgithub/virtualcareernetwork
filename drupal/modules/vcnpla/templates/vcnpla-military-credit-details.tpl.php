	...
	<div class="vcn-pla-buttons">
		<div id="vcnpla-details-page-search-again">
			...
			<?php else: ?>
				...
				<?php else: ?>
					<button class="vcn-button detail-back-buttons" id="button-back-to" onclick="location='<?php print $military_credit_link; ?>'" title="Back to Military Courses">Back to<br/> Military Courses</button>
				<?php endif; ?>
			<?php endif; ?>
		</div>
...
<div id="vcnpla-military-credit-details-ace-id">
	<strong>ACE ID:</strong> <?php print $ace_id; ?>
</div>

<?php if(!empty($first_title)): ?>
	<div id="vcnpla-military-credit-details-first-title">
		<strong>Primary Title:</strong> <?php print $first_title; ?>
	</div>
<?php endif; ?>

<?php if(!empty($second_title)): ?>
	<div id="vcnpla-military-credit-details-secondary-title">
		<strong>Secondary Title:</strong> <?php print $second_title; ?>
	</div>
<?php endif; ?>

<?php if(!empty($military_course_id_str)): ?>
	<div id="vcnpla-military-credit-details-military-course-id">
		<strong>Applicable Military Courses:</strong> <?php print $military_course_id_str; ?>
	</div>
<?php endif; ?>

<?php if(!empty($objective)): ?>
<div id="vcnpla-military-credit-details-objective">
	<strong>Objective:</strong> <?php print $objective; ?>
</div>
<?php endif; ?>

<?php if(!empty($instruction)): ?>
<div id="vcnpla-military-credit-details-instruction">
	<strong>Instruction:</strong> <?php print $instruction; ?>
</div>
<?php endif; ?>

<?php if(!empty($course_credit_info_str)): ?>
<div id="vcnpla-military-credit-details-course-hours">
