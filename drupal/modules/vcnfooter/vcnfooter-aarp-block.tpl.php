...
<div id="copyright">
  ...
  <p class="copyright-text">
    The <?php echo vcn_get_industry_name(); ?> VCN initiative is sponsored by AARP Foundation and the U.S. Department of Labor, Employment under the leadership of the American Association of Community Colleges.
    <br /><br />
  ...
  <a class="foundation-footer-logo" href="javascript:popit('http://aarpfoundation.org')" title="AARP">
    <img src="<?php echo vcn_industry_image_path() ?>site_logo_images/industry_foundation_logo_footer.png" alt="AARP" />
  </a>
</div>
