  ...
  <div id="vcn-footer-navigation">
    <br/>
      ...
      <ul class="vcn-footer-links">
        ...
        <?php endif; ?>
        <li><a href="<?php echo $vcn_drupal7_base_path; ?>tool-kit" title="Link to Us and Open Source Portal">Link to Us</a></li>
        <li><a href="<?php echo $vcn_drupal7_base_path; ?>osp/welcome" title="Open Source">Open Source</a></li>
...
<div id="copyright">
  ...
  <p class="copyright-text">
    The <?php echo vcn_get_industry_name() == "Green" ? "IGEN" : vcn_get_industry_name(); ?> VCN initiative is sponsored by the U.S. Department of Labor, Employment and Training Administration 
