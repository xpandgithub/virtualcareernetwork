...
<?php if (vcn_header_footer_should_display()) { ?>
   ...
   <div id="vcn-header" class="noresize">
	  <div id="vcn-logo-block">
		<a class="<?php echo $logoclass ?>" href="<?php echo vcn_drupal7_base_path(); ?>" title="<?php echo vcn_get_industry_name(); ?> Home"></a>
	  </div> 
	  <div id="vcn-header-welcome-block" class="noresize">	  
        ...
        <div id="vcn-header-navbar" class="noresize">
  	      <div id="vcn-navbar-links" class="noresize">
  	        <ul>			 
              <li>
