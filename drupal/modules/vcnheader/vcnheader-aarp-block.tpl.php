...
if (vcn_header_footer_should_display()) { 
   ?><div id="vcn-industry-header" class="noresize" >
   		<div id="industry-header-topbar" class="industry-header-topbar vcn-round-border" >
	  	<div class="industry-header-left"><a href="<?php echo vcn_drupal7_base_path(); ?>" title="<?php echo $industry_name; ?> Home"><div id="industry-header-logo" class="industry-header-logo" ></div></a></div>
	  	<div class="industry-header-center"><!-- <a href="http://www.aarp.org/aarp-foundation/" target="_blank" title="AARP Foundation"> --><img class="industry-foundation-logo" src="<?php echo $vcn_industry_image_path;?>site_logo_images/industry_foundation_logo.png" alt="logo" border="0" /><!-- </a> --></div>
	  	<div id="industry-header-right" class="industry-header-right">
