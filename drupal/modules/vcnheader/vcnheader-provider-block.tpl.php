...
if (vcn_header_footer_should_display()) { 
   ?><div id="vcn-industry-header" class="noresize" >
	  <div id="industry-header-topbar" >
	  	<div class="industry-header-left"><a href="<?php echo vcn_drupal7_base_path(); ?>" title="<?php echo vcn_get_industry_name(); ?> Home"><div id="provider-header-logo" ></div></a></div>
          ...
          <div id="vcn-header-welcome-links" class="noresize">
              <?php if (!$is_logged_in_user) { ?>	        
                <a title="Sign In" href="<?php echo vcn_drupal7_base_path(); ?>user?type=provider">Sign In</a> 
