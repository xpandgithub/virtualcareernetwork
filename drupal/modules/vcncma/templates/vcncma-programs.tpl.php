...
<h1 class="title"><?php echo $cmatitle;?> Education Programs</h1>
...
<div id="vcn-tabs-blueborder" class="<?php print $tab_counselor_class; ?>">
	<div id="cma-programs" class="cma-main-content">
		<?php if($cma_no_programs_saved): ?>
			<div class="vcn-note">*No programs have been saved.</div>
		<?php else: ?>
			<div id="vcncma-programs-listing">
				<table id="cma-programs-listing" class="dttable">
					<thead>
						<tr><th class="dtheader"></th><th class="dtheader sorting">Program Name</th><th class="dtheader sorting">School Name</th><th class="dtheader sorting">Education Level</th><th class="dtheader">Action</th></tr>
					</thead>
					<tbody>
						<tr><td colspan="4" class="dataTables_empty">Loading data from server</td></tr>
					</tbody>
				</table>
        		<p class="strong">Click on a Target button to change your target program.</p>
			</div>
		<?php endif; ?>
