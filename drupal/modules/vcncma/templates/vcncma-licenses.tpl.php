...
<h1 class="title"><?php echo $cmatitle;?> Required Licenses</h1>
...
<div id="vcn-tabs-blueborder" class="<?php print $tab_counselor_class; ?>">
	<div id="cma-licenses" class="cma-main-content">
		<?php if($cma_no_licenses_saved): ?>
			<div class="vcn-note">*No licenses have been saved.</div>
		<?php else: ?>
			<div id="vcncma-licenses-listing">
				<table id="cma-licenses-listing" class="dttable">
					<thead>
						<tr><th class="dtheader sorting">License Name</th><th class="dtheader sorting">Licensing Agency</th><th class="dtheader">Action</th></tr>
					</thead>
					<tbody>
