				...
				"fnRowCallback": function( nRow, aData, iDisplayIndex ) {
					...
					$('td:eq(1)', nRow).html(aData.license_agency);
                                        ...
                                        if (councelor_viewing_student_data == true && user_not_in_save_mode == true) {
                                          $('td:eq(0)', nRow).html('<strong>'+ aData.license_title + '</strong>' + targeted_license + '<br/>' + aData.license_description);
                                          ...
                                          $('td:eq(0)', nRow).html('<a href="'+basepath+'get-qualified/license/'+aData.itemid+'/location/'+aData.license_state+'/onetcode/'+aData.onetcode+'"><strong>'+ aData.license_title + '</strong></a>' + targeted_license + '<br/>' + aData.license_description);
                                          $('td:eq(2)', nRow).html('<center><nobr>'+
