...
<h1 class="title">MyVCN Account: Forgot Password</h1>
<div id="vcn-login-register">
	<div class="vcn-tabs-blueheader">
		...
		<img class="floatleft" width="3" src="<?php print $image_path; ?>miscellaneous/transparent.gif" alt="">
		<?php if($is_provider_sign_in): ?>
			<a title="Forgot Password" href="<?php print $base_path; ?>user/password?type=password" class="vcn_tabs-links" id="istartlink">
		<?php else: ?>
	...
	<div id="vcn-login-register-form-wrapper">
		<fieldset>
			<legend>Username or E-mail</legend>
		...
		<div class="vcn-login-register-form-buttons-wrapper">
			...
			<input class="vcn-button form-submit login-register-cancel-button" type="submit" id="password-cancel-button" name="op" value="Cancel" title="Cancel">
		</div>		
	</div>
</div>
