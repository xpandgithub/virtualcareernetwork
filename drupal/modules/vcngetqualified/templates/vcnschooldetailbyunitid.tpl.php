 ...
 */
?>
<div id="school-profile" class="allclear">
  <div id="school-profile-top">	
	<div id="school-profile-top-title">
		...
		<hr class="divider">
		<div id="school-profile-top-desc"><?php 
			 
			if (isset($missionstatementurl)) { ?>
				<div><?php echo $missionstatementurl; ?></div><?php 
			}
			if (isset($applurl)) { ?>
	   			<div><?php echo $applurl; ?></div><?php 
	   		}			
			if (isset($address)) { ?>
	   			<div><b>Address:</b> <?php echo $address; ?></div><?php 
	   		}
			if (isset($phone)) { ?>
	   			<div><b>Phone:</b> <?php echo $phone; ?></div><?php 
	   		}
			if (isset($webaddr)) { ?>
	   			<div><b>Website:</b> <?php echo $webaddr; ?></div><?php 
	   		} ?>
  ...
  <div id="school-profile-tabs">	
	...
	<div id="<?php echo $vcn_tabs_body_id_prefix; ?>desc" class="school-profile-tabs-body">
		<div id="school-profile-bottom" class="allclear">
			<?php 
			if (isset($missionstatement)) { ?>
				<div><?php echo $missionstatement; ?></div><?php 
			}
			?>	   		
	   		<div>
	...
	<div id="<?php echo $vcn_tabs_body_id_prefix; ?>test" class="school-profile-tabs-body tabhide">
		<div>
	   	  ...
	   	  <div class="floatleft school-profile-tabs-detail">
	   	  	<div><?php echo $entrancetests; ?></div>
	   	  	<div><?php 
			...
			<div><?php if(empty($flag) && isset($entrancetests_na)) { echo $entrancetests_na; } ?></div>
	   	  </div>
	   	  <div class="allclear"></div>
	   	</div>
	</div>
