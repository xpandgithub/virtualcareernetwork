  ...
  <div>
	...
	<!-- VCN Navigation bar -->
      <div class="vcn-user-navigation-bar allclear">
      	...
      	<div class="nav-bar-left"><div><a title="Back to <?php echo strpos($_SERVER["HTTP_REFERER"], "/cma/") ? (strpos($_SERVER["HTTP_REFERER"], "/wishlist") ? "Career Wishlist" : "Review Saved Certifications") : "Get Qualified"; ?>" href="<?php echo strpos($_SERVER["HTTP_REFERER"], "/cma/") ? "javascript:history.go(-1);" : vcn_drupal7_base_path()."get-qualified/certifications";?><?php //echo $back_to_wishlist_link_suffix; ?>" >Back to <?php echo strpos($_SERVER["HTTP_REFERER"], "/cma/") ? (strpos($_SERVER["HTTP_REFERER"], "/wishlist") ? "Career Wishlist" : "Review Saved Certifications") : "Get Qualified"; ?></a></div></div>	      	
