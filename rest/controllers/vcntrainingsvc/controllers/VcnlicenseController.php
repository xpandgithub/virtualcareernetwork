...
class VCNTrainingSvc_VCNLicenseController extends VCN_WebServices {
	
  public function getLicensesAction() {
		
		$model = new VCN_Model_VCNLicense();
		$data = $model->getLicenses($this->params);
  ...
  public function getLicenseAction() {
		...
		$model = new VCN_Model_VCNLicense();
		$data = $model->getLicense($this->params);
	...
	public function getBlacklistAction() {
		...
		$model = new VCN_Model_VCNLicense();
		$data = $model->getBlacklist($this->params);
