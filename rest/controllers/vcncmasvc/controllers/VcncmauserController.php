...
class VCNCmaSvc_VCNCmaUserController extends VCN_WebServices {	
  ...
  public function updateUserCourseCompletedAction() {
	
		$model = new VCN_Model_VCNCmaUser();
		$data = $model->updateUserCourseCompleted($this->params);
	...
	public function getCmaUserInfoAction() {
	
		$model = new VCN_Model_VCNCmaUser();
		$data = $model->getCmaUserInfo($this->params);
	...
	public function updateCmaUserInfoAction() {
	
		$model = new VCN_Model_VCNCmaUser();
		$data = $model->updateCmaUserInfo($this->params);
  ...
  public function getCmaUserAssessmentValuesAction() {
	
		$model = new VCN_Model_VCNCmaUser();
		$data = $model->getCmaUserAssessmentValues($this->params);
	...
	public function updateCmaUserAssessmentValuesAction() {
	
		$model = new VCN_Model_VCNCmaUser();
		$data = $model->updateCmaUserAssessmentValues($this->params);
